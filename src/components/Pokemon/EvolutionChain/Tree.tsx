        ...
        <div className="relative flex flex-col items-center justify-content-center">
            ...
            >
                ...
                <Link
                    ...
                    className="card-pokemon-container flex flex-col items-center group rounded-xl"
                    style={{
                ...
                >
                    <div
                        className={clsx(
                            "relative flex flex-col items-center justify-center border border-border/50 bg-foreground/10 rounded-xl p-2.5 transition duration-300",
                            {
            ...
            {hasEvolution && (
                <div
                    className={clsx(
                        "relative flex flex-wrap gap-10",
                        isMobile
