...
import { Bars3Icon as MenuIcon, MagnifyingGlassIcon as SearchIcon, XMarkIcon as XIcon } from "@heroicons/react/20/solid";
                    ...
                    <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                        <div className="relative flex items-center justify-between h-16">
                            <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                                ...
                                <DisclosureButton className="inline-flex items-center justify-center p-2 rounded dark:text-gray-400 text-gray-800 dark:hover:text-white dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
